#ifndef GRAPHCOREARCITERATOR_H
#define GRAPHCOREARCITERATOR_H
...
class GraphCore::ArcIterator : public iterator< forward_iterator_tag, const Arc >
{
public:
