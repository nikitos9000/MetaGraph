#ifndef GRAPHCOREVERTEXITERATOR_H
#define GRAPHCOREVERTEXITERATOR_H
...
class GraphCore::VertexIterator : public iterator< forward_iterator_tag, const Vertex >
{
public:
...
#endif // GRAPHCOREVERTEXITERATOR_H
