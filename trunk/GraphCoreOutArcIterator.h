#ifndef GRAPHCOREOUTARCITERATOR_H
#define GRAPHCOREOUTARCITERATOR_H
...
class GraphCore::OutArcIterator : public iterator< forward_iterator_tag, const Arc >
{
public:
...
#endif // GRAPHCOREOUTARCITERATOR_H
